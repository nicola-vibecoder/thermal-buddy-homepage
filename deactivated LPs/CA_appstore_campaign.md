...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin: 3rem 0;">
  <img src="{{ '/assets/images/campaign-1.png' | relative_url }}?v=3" alt="Step 1" style="width: 100%; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);" />
  <img src="{{ '/assets/images/campaign-2.png' | relative_url }}?v=3" alt="Step 2" style="width: 100%; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);" />
